...
import co.harborbytes.wortedeck.user.dto.UserAuthenticatedDTO;
import co.harborbytes.wortedeck.user.dto.UserCreateInputDTO;
import co.harborbytes.wortedeck.user.dto.UserLoginDTO;
...
public class UserService {
    ...
    private final String userCreatedSuccesfullyMessage = "User registered succesfully";
    ...
    @Transactional
    public String register(UserCreateInputDTO userCreateInputDTO) {
        ...
        User user = userMapper.dtoToUser(userCreateInputDTO);
    ...
    public UserAuthenticatedDTO login(UserLoginDTO userLoginDTO) {
    ...
    public UserAuthenticatedDTO googleLogin(final String googleIdToken) {
        User tokenUser = this.googleTokenVerificationService.verify(googleIdToken);
